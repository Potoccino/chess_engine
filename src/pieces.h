...
const u_short ROOK_TAKEN = 0;
const u_short KNIGHT_TAKEN = 1;
const u_short BISHOP_TAKEN = 2;
const u_short QUEEN_TAKEN = 3;
const u_short NOTHING_TAKEN = 4;
const u_short PAWN_TAKEN = 5;

const u_short ROOK_PROMOTED = 0;
const u_short KNIGHT_PROMOTED = 1;
const u_short BISHOP_PROMOTED = 2;
const u_short QUEEN_PROMOTED = 3;
const u_short NOTHING_PROMOTED = 4;
